...
const getRuleConfig = (): RuleConfig => {
  return {
    ...
    creDtTm: '2026-05-22T10:20:00Z',
    updDtTm: '2026-05-22T10:20:00Z',
    tenantId: 'DEFAULT',
  };
};
